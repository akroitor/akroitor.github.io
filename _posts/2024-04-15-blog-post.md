...
Introduction
=====
The Riemann zeta function is the unique analytic continuation of the function \\(\zeta(s) = \sum_{n \geq 1} \frac{1}{n^s}\\) (a priori defined only on \\(s \in \R \times i \R_+ \\) ) to the whole complex plane.
